...
export const DevDiffEventSchema = z.object({
  ...
  config: z.object({
    ...
    depth: z.enum(['minimal', 'standard', 'deep', 'exhaustive']).default('standard'),
...
export const CustomPersonaConfigSchema = z.object({
  ...
  format_preference: z.enum(['paragraphs', 'bullets', 'tables', 'mixed']).optional(),
...
export class ValidationMiddleware {
   ...
   */
  static validate<T>(schema: z.Schema<T>, data: unknown): { success: true; data: T } | { success: false; errors: string[] } {
