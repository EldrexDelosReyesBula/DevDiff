...
1. Download the packaged artifact: `devdiff-1.0.6.vsix` (also available on [GitHub Releases](https://github.com/EldrexDelosReyesBula/devdiff/releases))
2. Open VS Code.
...
6. Select the downloaded `devdiff-1.0.6.vsix` file and click **Install**.
