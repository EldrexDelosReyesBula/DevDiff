export const SECURITY_ADVISORIES = [
  ...
  },
  {
    ...
    description:
      "Commit messages containing LLM injection sequences could manipulate AI output",
  ...
  },
  {
    ...
    description:
      "WS endpoint accepted unauthenticated connections in default config",
  ...
  },
  {
    ...
    description:
      "Environment variable values could appear in diagram node labels",
  ...
  },
  {
    ...
    description:
      "Stack traces could reveal internal file paths in API responses",
