...
export const MESSAGING_CONNECTORS = {
  ...
  teams: {
    ...
    icon: "🏢",
    setup:
      "Create incoming webhook: Teams Channel → Connectors → Incoming Webhook",
    config: {
      webhookUrl: { type: "string", secret: false, required: true },
    },
  ...
  whatsapp: {
    ...
    icon: "📱",
    setup:
      "Twilio: https://www.twilio.com/whatsapp OR Meta: https://developers.facebook.com/docs/whatsapp",
    config: {
      provider: {
        type: "string",
        secret: false,
