...
- **GitHub Private Advisory**: [Create Private Security Advisory](https://github.com/EldrexDelosReyesBula/DevDiff/security/advisories/new)
- **Direct Email**: `eldrexdelosreyesbula@gmail.com`
